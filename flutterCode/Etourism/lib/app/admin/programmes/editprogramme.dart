...
class UpdateProgrammePage extends StatefulWidget {
  @override
  _UpdateProgrammePageState createState() => _UpdateProgrammePageState();
}

class _UpdateProgrammePageState extends State<UpdateProgrammePage> {
  ...
  Future<void> _updateProgramme() async {
    if (_formKey.currentState!.validate()) {
      ...
      var request = http.MultipartRequest('POST', Uri.parse(programmeUpdate));
      ...
      // Prepare data for updating the programme
      ...
      try {
        ...
        if (responseJson['status'] == 'success') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content:
                Text('Failed to update programme: ${responseJson['message']}'),
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              ElevatedButton(
                onPressed: isLoading ? null : _updateProgramme,
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF33579B),
                  foregroundColor: Colors.white,
                  padding:
